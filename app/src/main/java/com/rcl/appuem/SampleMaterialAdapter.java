...
public class SampleMaterialAdapter extends RecyclerView.Adapter<SampleMaterialAdapter.ViewHolder> {
    ...
    public void addCard(String name, int color) {
        ...
        cardsList.add(card);
        ((ListaActivity) context).doSmoothScroll(getItemCount());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Pair<View, String> p1 = Pair.create((View) initial, ListaActivity.TRANSITION_INITIAL);
                    Pair<View, String> p2 = Pair.create((View) name, ListaActivity.TRANSITION_NAME);
                    Pair<View, String> p3 = Pair.create((View) deleteButton, ListaActivity.TRANSITION_DELETE_BUTTON);
                    ...
                    transitionIntent.putExtra(ListaActivity.EXTRA_NAME, name);
                    transitionIntent.putExtra(ListaActivity.EXTRA_INITIAL, Character.toString(name.charAt(0)));
                    transitionIntent.putExtra(ListaActivity.EXTRA_COLOR, color);
                    transitionIntent.putExtra(ListaActivity.EXTRA_UPDATE, false);
                    transitionIntent.putExtra(ListaActivity.EXTRA_DELETE, false);
